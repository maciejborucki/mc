...
import static pl.mi.mcloud.selfcare.EJBBus.complaintHistoryFacade;
import static pl.mi.mcloud.selfcare.EJBBus.jobFacade;
import static pl.mi.mcloud.selfcare.EJBBus.jobHistoryFacade;
...
public class HistoryService {    
    ...
    static boolean makeHistoricalEntry(Job newJob) {
        Job oldJob = jobFacade.find(newJob.getId());
        ...
        try {
            jobHistoryFacade.create(jobHistoryEntry);
    ...
    static boolean makeHistoricalEntry(Complaint newComplaint) {
        Complaint oldComplaint = complaintFacade.find(newComplaint.getId());
        ...
        try {
            complaintHistoryFacade.create(complaintHistoryEntry);
